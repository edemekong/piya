...
export const dummyDiscounts: DiscountData[] = [
  ...
  },
  {
    ...
    createdBy: "admin_demo",
    title: "Free Mini Serum",
    description: "Free mini serum with an eligible purchase.",
    status: "paused",
    code: "FREESERUM",
    reward: {
      metadata: { giftId: "gift_mini_glow_serum" },
...
export const dummyOfferings: OfferingData[] = [
  {
    ...
    type: "product",
    subType: "physical",
    category: { id: "beauty_personal_care", name: "Beauty and personal care" },
    status: "active",
    price: 45000,
    currency: "NGN",
    inventory: {
  ...
  },
  {
    ...
    type: "product",
    subType: "digital",
    category: { id: "digital_products", name: "Digital products" },
    status: "draft",
    price: 15000,
    currency: "NGN",
    inventory: null,
